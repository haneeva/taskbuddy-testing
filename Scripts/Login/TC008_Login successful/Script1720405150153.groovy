...
String ActualLoginPageSuccess = WebUI.getUrl()
String ExpectedLoginPageSuccess = 'https://task-buddy-d414881265e1.herokuapp.com/dashboard'

WebUI.verifyMatch(ActualLoginPageSuccess, ExpectedLoginPageSuccess, false)

println('Login success and direct to Dashboard Page')
