...
String ActualEmptyData = WebUI.getUrl()
String ExpectedEmptyData = 'https://task-buddy-d414881265e1.herokuapp.com/login'

WebUI.verifyMatch(ActualEmptyData, ExpectedEmptyData, false)

WebUI.takeScreenshot('C:\\Taskbuddy\\ErrorEmptyData.png')
