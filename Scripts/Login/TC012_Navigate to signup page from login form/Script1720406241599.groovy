...
WebUI.click(findTestObject('Object Repository/Login/Page_TaskBuddy/a_Register'))

String ActualRegisterPage = WebUI.getUrl()
String ExpectedRegisterPage = 'https://task-buddy-d414881265e1.herokuapp.com/register'

WebUI.verifyMatch(ActualRegisterPage, ExpectedRegisterPage, false)

println('The Register page is displayed')

WebUI.takeScreenshot('C:\\Taskbuddy\\RegisterPage2.png')