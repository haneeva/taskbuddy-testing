...
String ActualLoginPage = WebUI.getUrl()
String ExpectedLoginPage = 'https://task-buddy-d414881265e1.herokuapp.com/dashboard'

WebUI.verifyMatch(ActualLoginPage, ExpectedLoginPage, false)

String ActualDashboardPage = WebUI.getText(findTestObject('Object Repository/Registration/Page_TaskBuddy/strong_taskbuddy_title'))
String ExpectedDashboardPage = 'Task Buddy'

WebUI.verifyMatch(ActualDashboardPage, ExpectedDashboardPage, false)

WebUI.takeScreenshot('C:\\Taskbuddy\\Dashboard.png')
