...
String ActualInvalidEmailPage = WebUI.getUrl()
String ExpectedInvalidEmailPage = 'https://task-buddy-d414881265e1.herokuapp.com/register'

WebUI.verifyMatch(ActualInvalidEmailPage, ExpectedInvalidEmailPage, false)

WebUI.takeScreenshot('C:\\Taskbuddy\\InvalidEmail.png')
