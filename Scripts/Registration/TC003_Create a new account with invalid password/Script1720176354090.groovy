...
String ActualInvalidPasswordPage = WebUI.getUrl()
String ExpectedInvalidPasswordPage = 'https://task-buddy-d414881265e1.herokuapp.com/register'

WebUI.verifyMatch(ActualInvalidPasswordPage, ExpectedInvalidPasswordPage, false)

WebUI.takeScreenshot('C:\\Taskbuddy\\InvalidPassword.png')
