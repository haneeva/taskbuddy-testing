...
String ActualPriorityLabel = WebUI.getText(findTestObject('Object Repository/Story/Page_TaskBuddy/strong_Priority_Label'))
String ExpectedPriorityLabel = 'Priority'

WebUI.verifyMatch(ActualPriorityLabel, ExpectedPriorityLabel, false)

WebUI.selectOptionByValue(findTestObject('Object Repository/Story/Page_TaskBuddy/select_Select priority.                    _6b5064'),
	'Medium', true)

println('Priority is selected')
...
WebUI.click(findTestObject('Object Repository/Story/Page_TaskBuddy/a_Cancel'))

println('Cancel button is clickable')

//Verify cancel create story

String ActualStoryList = WebUI.getUrl()
String ExpectedStoryList = 'https://task-buddy-d414881265e1.herokuapp.com/dashboard/stories'

WebUI.verifyMatch(ActualStoryList, ExpectedStoryList, false)

println('Back to Story menu')
