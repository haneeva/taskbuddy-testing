...
WebUI.click(findTestObject('Object Repository/Story/Page_TaskBuddy/a_Return to Story'))

println('Return to Story button is clickable')

//Verify navigate to story menu

String ActualNavigateToStory = WebUI.getUrl()
String ExpectedNavigateToStory = 'https://task-buddy-d414881265e1.herokuapp.com/dashboard/stories'

WebUI.verifyMatch(ActualNavigateToStory, ExpectedNavigateToStory, false)

println('Story cancel to delete')
